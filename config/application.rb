...
module Comunidadmanager
  class Application < Rails::Application
    ...
    # integrando validacion twitter bootstrap
    ActionView::Base.field_error_proc = Proc.new do |html_tag, instance|
      ...
      elements.each do |e|
        if e.node_name.eql? 'label'
          ...
          html = %(<div class="control-group"><div class="field_with_errors">#{html_tag}</div>).html_safe
          html = %(<div class="control-group error">#{e}).html_safe
